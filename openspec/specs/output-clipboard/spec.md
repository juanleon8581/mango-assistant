# Spec: output-clipboard

## Purpose

Define the behavior for copying macro output to the system clipboard, including the plain-text buffer that stores output independently of the Rich-rendered display.
